...
"""
class Track:
    def __init__(self, name, album, artists, popularity, track_id, album_id, duration_ms, explicit, release_date):
        self.name = name
        self.album = album
    ...
    def __str__(self):
        return f"[name={self.name}, album={self.album}, artists={self.artists}, " \
               ...
               f"duration_ms={self.duration_ms}, explicit={self.explicit}, " \
